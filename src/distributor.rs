...
impl Neighborhood {
    ...
    pub fn new(peer_summary_info: ArcShift<PeerSummaryInfo>, now: Instant) -> Neighborhood {
        Self {
            peers: Peers {
...
impl Distributor {
    ...
    pub(crate) fn new(periodic_message_interval: Duration, initial_node_id: ArcShift<EphemeralNodeId>, peer_info: ArcShift<PeerSummaryInfo>) -> Distributor {
        Self {
            ...
            neighborhood: Neighborhood::new(peer_info, tokio::time::Instant::now().into()),
        }
    }
